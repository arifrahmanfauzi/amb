                                ...
                                <div class="example-content bg-light">
                                    <div class="alert alert-custom" role="alert">
                                        ...
                                        <div class="alert-content d-flex">
                                            <div class="col-xl-5">
                                                <audio controls>
                                                    <source src="{{ env('APP_URL') }}/storage/tamrin/{{ $tadrib->berkas[0]['file_name'] }}"
                                                        type="audio/mpeg">
                                                </audio>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card widget widget-info">
                                            <div class="card-body">
                                                <div class="widget-info-container">
                                                    <div class="widget-info-image" style="background: url({{ env('APP_URL') }}/storage/tamrin/{{ $tadrib->berkas[0]['file_name'] }})"></div>
                                                    <audio controls>
                                                        <source src="{{ env('APP_URL') }}/storage/tamrin/{{ $tadrib->berkas[0]['file_name'] }}"
                                                            type="audio/mpeg">
                                                    </audio>
