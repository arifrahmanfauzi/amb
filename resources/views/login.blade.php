...
<head>
    ...
    <link href="{{ env('APP_URL') }}/assets/plugins/perfectscroll/perfect-scrollbar.css'" rel="stylesheet">
...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
     ...
     <script src="{{ env('APP_URL') }}/assets/plugins/perfectscroll/perfect-scrollbar.min.js"></script>
