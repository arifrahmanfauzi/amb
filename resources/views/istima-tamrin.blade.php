                        ...
                        <div class="card-body d-flex align-items-center">
                            <div class="card-body d-flex align-items-center">
                                <a href="javascript:playSound({{ $tamrin->id }})">
                                    <img src="{{ url('/') }}/storage/istimaTamrin/{{ $tamrin->berkas[1]->file_name }}" alt="" class="rounded"
                        ...
                        <div class="alert-content">
                            <div class="example">
                                <p>Dengarkan dan jawablah pertanyaan di bawah ini dengan benar!
                                    ...
                                    <a href="https://docs.google.com/forms/d/1gpw1VyGbUrWyksLYZR_UXHhHo03CZi8NqKjz_5uLRMw/edit?usp=sharing" target="_blank">Klik Disini</a>
                                {{-- <audio controls="">
                                    @switch($id)
                                        @case(4)
